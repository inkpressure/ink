...
)  # (ink/config/settings/base.py - 3 = ink/)
APPS_DIR = ROOT_DIR.path("ink")
...
MIGRATION_MODULES = {"sites": "ink.contrib.sites.migrations"}
...
ADMINS = [("""Nick Kyriakakis""", "nick@inkpressure.com")]
